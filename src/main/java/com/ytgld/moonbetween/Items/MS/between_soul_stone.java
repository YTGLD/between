...
public class between_soul_stone extends ItemRing implements IAnimatorRepairable {
    @Override
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        list.addAll(ItemTooltipHandler.splitTooltip(I18n.format("tooltip.moon.between_soul_stone.bonus", new Object[0]), 0));
    ...
    public between_soul_stone(){
        this .setRegistryName(new ResourceLocation(MoonBetween.MODID, "between_soul_stone"))
                .setCreativeTab(BLCreativeTabs.ITEMS)
                .setUnlocalizedName(MoonBetween.MODID + ".between_soul_stone");
