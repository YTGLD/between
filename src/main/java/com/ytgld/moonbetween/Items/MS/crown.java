...
public class crown extends ItemRing implements IAnimatorRepairable {
    @Override
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        list.addAll(ItemTooltipHandler.splitTooltip(I18n.format("tooltip.moon.crown.bonus", new Object[0]), 0));
    ...
    public crown(){
      this    .setRegistryName(new ResourceLocation(MoonBetween.MODID, "crown"))
                .setCreativeTab(CreativeTabs.MISC)
                .setUnlocalizedName(MoonBetween.MODID + ".crown").setMaxDamage(96);
