...
public class between_book extends ItemRing implements IAnimatorRepairable {
    @Override
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        list.addAll(ItemTooltipHandler.splitTooltip(I18n.format("tooltip.moon.between_book.bonus", new Object[0]), 0));
    ...
    public between_book(){
        this .setRegistryName(new ResourceLocation(MoonBetween.MODID, "between_book"))
                .setCreativeTab(CreativeTabs.MISC)
                .setUnlocalizedName(MoonBetween.MODID + ".between_book");
