...
public class die_bone extends ItemRing implements IAnimatorRepairable {
    @Override
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        list.addAll(ItemTooltipHandler.splitTooltip(I18n.format("tooltip.moon.die_bone.bonus", new Object[0]), 0));
    ...
    public die_bone(){
        this    .setRegistryName(new ResourceLocation(MoonBetween.MODID, "die_bone"))
                .setCreativeTab(BLCreativeTabs.ITEMS)
                .setUnlocalizedName(MoonBetween.MODID + ".die_bone").setMaxDamage(512);
