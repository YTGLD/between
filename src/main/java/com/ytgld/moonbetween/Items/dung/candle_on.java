...
import thebetweenlands.client.tab.BLCreativeTabs;import thebetweenlands.client.tab.BLCreativeTabs;
...
public class candle_on extends Item implements IEquippable, IAnimatorRepairable {
    public candle_on() {
        this.setRegistryName(new ResourceLocation(MoonBetween.MODID, "candle_on"))
                .setCreativeTab(BLCreativeTabs.ITEMS)
                .setUnlocalizedName(MoonBetween.MODID + ".candle_on");
        ...
        if (event.getSource() != null && event.getSource().getTrueSource() instanceof EntityPlayer){
            ...
            if (cap != null) {
                ...
                for (int i = 0; i < inv.getSizeInventory(); i++) {
                    ...
                    if (stack.getItem() == MoonBetween.candle_on) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        ...
        list.addAll(ItemTooltipHandler.splitTooltip(I18n.format("tooltip.moon.candle_on.bonus", new Object[0]), 0));
