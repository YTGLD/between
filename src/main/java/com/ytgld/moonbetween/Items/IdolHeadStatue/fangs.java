...
public class fangs extends IdolHead {
    public fangs(){
        this.setRegistryName(new ResourceLocation(MoonBetween.MODID, "fangs"))
                .setCreativeTab(BLCreativeTabs.ITEMS)
                .setUnlocalizedName(MoonBetween.MODID + ".fangs");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        list.addAll(ItemTooltipHandler.splitTooltip(I18n.format("tooltip.moon.fangs.bonus", new Object[0]), 0));
