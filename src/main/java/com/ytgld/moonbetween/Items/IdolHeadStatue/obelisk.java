...
public class obelisk extends IdolHead {
    public obelisk(){
        this.setRegistryName(new ResourceLocation(MoonBetween.MODID, "obelisk"))
                .setCreativeTab(BLCreativeTabs.ITEMS)
                .setUnlocalizedName(MoonBetween.MODID + ".obelisk");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        list.addAll(ItemTooltipHandler.splitTooltip(I18n.format("tooltip.moon.obelisk.bonus", new Object[0]), 0));
