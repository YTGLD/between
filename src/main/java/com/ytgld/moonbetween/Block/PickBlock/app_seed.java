...
public class app_seed extends ItemPlantableSeeds {
    public app_seed(){
        super(()->{
            return MoonBetween.appseed.getDefaultState();
        });
        this.setRegistryName(new ResourceLocation(MoonBetween.MODID, "app_seed"))
                .setCreativeTab(CreativeTabs.MISC)
                .setUnlocalizedName(MoonBetween.MODID + ".app_seed");
